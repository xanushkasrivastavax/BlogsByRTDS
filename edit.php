...
font-family: 'Roboto Serif', sans-serif;
    ...
    <h3 class="text-center">Create new post</h3>
        <div class="container">
            ...
            <input type="text" placeholder="Enter Your Blog Name" name="name"class="form-control  bg-light text-black my-3 text-center" value="<?php echo $blog_title; ?>" required>
