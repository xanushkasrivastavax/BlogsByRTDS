      ...
      <div class="row">
        ...
        <div class="col-md-6 contents">
          <div class="row justify-content-center">
            ...
            <form action="" method="post" action="../../controller/register.php">
            <div class="form-group first">
                <label for="name"><b>NAME</b>
                    <p id="fname"></p>
                </label>
                <input type="text" placeholder="Enter Your Name" class="form-control" name="user_name" value="" required>
                </div>
                <div class="form-group first">
                <label><b>EMAIL</b>
                    <p id="femail"></p>
                </label>
                <input type="text" placeholder="Enter Email as Username" class="form-control" name="email_id" value=""
                    required>
</div>
                <div class="form-group first">
                ...
                <input type="text" placeholder="Enter Phone Number" name="phone" class="form-control" value="" required>
</div>
...
<div class="form-group last mb-4">
  ...
  font-size: 16px;
                ...
                <button type="submit" class="btn btn-primary" name="submit">Register</button> </div>     
